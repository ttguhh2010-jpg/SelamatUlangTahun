...
new TypeIt("#teks2", {
  strings: ["aku harap, semesta selalu membahagiakan kamu bagimanapun caranya.", " ", "selamat ulang tahun ke 17, terima kasih sudah pernah singgah di hati ku ini.", " ", "- I always support you from afar "],
  startDelay: 2000,
  speed: 75,
  waitUntilVisible: true
}).go();
